<template>
  <div class="sidebar">
    <div class="col p_0 bar j-start a-start color_input_color fill_input_color">
	    ...
	    <input type="file" accept="image/*;capture=camera" style="display: none" ref="QR">
    </div>
